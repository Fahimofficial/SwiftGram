...
// Load local.properties for Telegram API credentials
...
android {
    ...
    defaultConfig {
        ...
        // Inject Telegram API credentials into BuildConfig
    ...
    packaging {
        ...
        // Handle multiple libc++_shared.so files from different dependencies
